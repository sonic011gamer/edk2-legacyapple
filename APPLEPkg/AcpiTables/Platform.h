...
//
#define EFI_ACPI_OEM_TABLE_ID                   SIGNATURE_64('A','P','P','L','E','D','K','2') // OEM table id 8 bytes long
...
#define EFI_ACPI_OEM_ID               {'A','P','P','L','E',' '} // OEMID 6 bytes
